const products = [
    ...
    { id: 4, name: 'レッドブル（紫）', price: 100, stock: 1100, genre: 'drink', image: 'images/redbull_purple.jpg' },
    ...
    { id: 7, name: 'マッチ', price: 90, stock: 10, genre: 'drink', image: 'images/match.jpg' },
    ...
    { id: 11, name: 'コーヒー（PET）', price: 90, stock: 20, genre: 'drink', image: 'images/coffee_pet.jpg' },
    ...
    { id: 15, name: 'コーラ（缶）', price: 60, stock: 10, genre: 'drink', image: 'images/cola_can.jpg' },
    { id: 16, name: 'ジンジャーエール（缶）', price: 60, stock: 10, genre: 'drink', image: 'images/gingerale.jpg' },
    ...
    { id: 22, name: 'カロリーメイト（チョコ）', price: 150, stock: 4, genre: 'snack', image: 'images/caloriemate_chocolate.jpg' },
    { id: 23, name: 'カロリーメイト（バニラ）', price: 150, stock: 4, genre: 'snack', image: 'images/caloriemate_vanilla.jpg' },
    { id: 24, name: 'カロリーメイト（メープル）', price: 150, stock: 4, genre: 'snack', image: 'images/caloriemate_maple.jpg' },
    { id: 25, name: 'カロリーメイト（チーズ）', price: 150, stock: 4, genre: 'snack', image: 'images/caloriemate_cheeze.jpg' },
    { id: 26, name: 'カロリーメイト（フルーツ）', price: 150, stock: 4, genre: 'snack', image: 'images/caloriemate_fruit.jpg' },
    { id: 27, name: 'チョコアイスバー', price: 120, stock: 0, genre: 'snack', image: 'images/chocoice.jpg' },
    { id: 28, name: 'じゃがりこ', price: 100, stock: 30, genre: 'snack', image: 'images/jagarico.jpg' },
    ...
    { id: 35, name: 'たけのこの里（2個）', price: 50, stock: 30, genre: 'snack', image: 'images/takenoko.jpg' },
    ...
    { id: 46, name: 'たべっ子どうぶつ', price: 30, stock: 20, genre: 'snack', image: 'images/tabekko.jpg' },
    ...
    { id: 49, name: 'スニッカーズ（2個）', price: 30, stock: 30, genre: 'snack', image: 'images/snickers.jpg' },
